    ...
    for epoch in range(1, config.NUM_EPOCHS + 1):
        ...
        for batch in pbar:
            ...
            with autocast():
                ...
                loss_B = (10.0 * loss_l1_B + config.LAMBDA_EDGE_B * grad_B +
                          config.LAMBDA_SKEL_B * loss_skel_B +
                          config.LAMBDA_ADV_B * loss_adv_B + 10.0 * loss_fm_B)
