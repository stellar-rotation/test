...
def train():
    ...
    opt_D = optim.Adam(D.parameters(), lr=config.LR_G * config.D2G_LR,
    ...
    for epoch in range(1, config.NUM_EPOCHS + 1):
        ...
        for batch in pbar:
            ...
            with autocast():
                ...
                loss_fm_B = sum(F.l1_loss(df.float(), dr.detach().float())
